...
// #define FFT_CONVOLVE // requires 2 blocks in
#define FFT_RADIX 4
#define FFT_VEC2
#define FFT_HORIZ     
...
uniform vec2 psizevec;
#define uP psizevec.x
#define uStride psizevec.y
...
//#if defined(FFT_P1) && 
#if defined(FFT_HORIZ) && !defined(FFT_DUAL) && defined(FFT_VEC8)
...
{
    //vec4 t = b;
    b = vec4(1.0, -1.0, 1.0, -1.0) * (a.yxwz - b.yxwz);
    a = a + b;
}
